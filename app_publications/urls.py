...
from app_publications.apps import AppPublicationsConfig
from app_publications.views import PostMyListView, PostMyDetailView, PostMyUpdateView, PostMyDeleteView, PostMyCreateView, \
    PostListView, PostDetailView, PostPayRedirectView

app_name = AppPublicationsConfig.name
